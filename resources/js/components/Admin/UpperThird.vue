    ...
    <div class="bg-purple-900 p-4">
        <div class="flex items-center">
            <div class="flex-1 flex items-center mr-4">
                <input v-model="text" type="text" class="flex-1 form-input border-0 shadow bg-purple-700 text-white" placeholder="Text (Markdown supported)...">
            </div>
...
export default {
    ...
    methods: {
        show() {
            axios.post('/output/upperthird', {text: this.text})
                .then(() => {
                    this.$notify({
                        type: 'success',
                        title: 'The upper third is now being shown',
